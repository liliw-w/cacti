...
CACTI (**C**hromatin **A**ssociation using **C**ombined **T**raits and **I**nterval windows) implements the *peak-window* version of the CACTI method for chromatin QTL mapping.
...
The implementation corresponds to the peak-window CACTI method described in the associated manuscript (bioRxiv).
